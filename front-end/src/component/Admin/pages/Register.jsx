...
const Register = () => {
    ...
    return (
        ...
        <NavAdmin/>
            ...
            <div className="row">
                <div className="col-md-4 mx-auto form-group" >
                <form onSubmit={handleSubmit} >

                    <div className="input-group mb-3">
                        <input className="form-control" type="text" name='full_name' onChange={changeValue} placeholder="Full Name"  />
                    </div>
                    ...
                    <div className="input-group mb-3">
                        ...
                        <input  className="form-control" type="email"name='email' onChange={changeValue} placeholder="you@gmail.com"  />
                    </div>
